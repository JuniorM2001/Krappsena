<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Krappsena._default" %>
                        ...
                        <div class="row">
                           ...
                           <!-- /.Registro de novedades-->
                            ...
                            <a href="#">
                              <div class="col-md-3 col-sm-6 col-xs-12">
                                  <div class="info-box">
                                    <span class="info-box-icon bg-black"><i class="fa fa-bullhorn"></i></span>
                                    <div class="info-box-content">
                                      <span class="info-box-text">Ver Novedades</span>
                                      <p>
                                          <small>
